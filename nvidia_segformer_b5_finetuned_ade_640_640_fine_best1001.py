# -*- coding: utf-8 -*-
"""nvidia/segformer-b5-finetuned-ade-640-640_Fine_best1001.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bTFgYFpGEJs7PxpsneRjGmCdFgNksJ0H
"""
...
# 기존 경로에서 이미지 파일 불러오기 (JPEG, JPG, PNG 파일 포함, 대소문자 구분 없음)
...
# 기존 경로에서 파일 이름에 따라 train 셋과 val 셋으로 나누기 (추가 경로는 따로 나누지 않음)
...
# 기존 이미지에 추가된 train과 validation 경로의 이미지를 통합
...
# 추가 경로에서 마스크(라벨) 파일 불러오기 (train과 validation 마스크)
...
# 기존 라벨에 추가된 train과 validation 마스크를 통합
...
# DataLoader 설정 (배치 크기 64, 셔플 있음/없음)
...
model_save_path = '/content/drive/MyDrive/nvidia_best2.pth'
...
model_save_path = '/content/drive/MyDrive/nvidia_best2_state_dict.pth'
